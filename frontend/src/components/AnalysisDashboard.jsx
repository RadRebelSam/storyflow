        ...
        <div className="dashboard container" style={{ paddingBottom: '4rem' }}>
            ...
            <div style={{ margin: '2rem 0' }}>
                ...
                <div style={{ display: 'flex', gap: '1rem', color: 'var(--text-secondary)' }}>
                    <span style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}><Clock size={16} /> {Math.floor(meta.duration / 60)} mins</span>
                    <span style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}><Award size={16} /> {analysis.learning_moments?.length || 0} Key Insights</span>
                </div>
            </div>
                ...
                <div className="main-content">
                        ...
                        <div style={{ position: 'relative', paddingBottom: '56.25%', height: 0, background: '#000' }}>
                            {videoId ? (
                                ...
                                <div style={{
                                    ...
                                    <h2 style={{ fontSize: '1.8rem', fontWeight: 'bold' }}>Analysis Complete</h2>
                    ...
                    <div className="narrative-arc card">
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                            {analysis.narrative_arc?.map((phase, idx) => (
                                <div key={idx} style={{
                                    display: 'flex',
                                    gap: '1rem',
                                    padding: '1rem',
                    ...
                    <div style={{ marginTop: '2rem' }}>
                        ...
                        <div style={{ display: 'grid', gap: '1rem' }}>
                            {analysis.learning_moments?.map((moment, idx) => (
                                <div key={idx} className="card"
                                    onClick={() => seekTo(moment.timestamp_start ? convertTimestampToSeconds(moment.timestamp_start) : 0)} // Assuming convert helper or backend sends seconds
...
// Start MM:SS -> Seconds helper, assuming backend returns MM:SS mostly from prompt, 
// but backend services/transcription.py returns logic based on seconds.
// Ideally backend analysis returns seconds or we parse strictly.
// For robustness let's add a parser
